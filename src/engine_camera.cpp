...
void EngineCamera::setOrthographicProjection(float left,
                                             float right,
                                             float top,
                                             float bottom,
                                             float near,
...
void EngineCamera::setPerspectiveProjection(float fovy,
                                            float aspect,
                                            float near,
                                            float far)
{
...
void EngineCamera::setViewDirection(glm::vec3 position,
                                    glm::vec3 direction,
                                    glm::vec3 up)
{
...
void EngineCamera::setViewTarget(glm::vec3 position,
                                 glm::vec3 target,
                                 glm::vec3 up)
{
