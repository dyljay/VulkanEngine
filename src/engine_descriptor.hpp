...
class EngineDescriptorSetLayout {
   public:
    ...
    EngineDescriptorSetLayout& operator=(
        const EngineDescriptorSetLayout&) = delete;
   ...
   public:
    class Builder {
       public:
        ...
        Builder& addPoolSizeRatioVector(
...
class EngineDescriptorWriter {
   public:
    ...
    EngineDescriptorWriter& writeBuffer(
        uint32_t binding,
        VkDescriptorBufferInfo* bufferInfo);
    EngineDescriptorWriter& writeImage(uint32_t binding,
                                       VkDescriptorImageInfo* imageInfo);
    EngineDescriptorWriter& writeBulkImage(
        uint32_t binding,
